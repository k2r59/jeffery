...
enum WorkoutLibrary {
    ...
    static let all: [Workout] = [
        ...
        // Renforcement
        Workout(id: "str-b1", kind: .functionalStrength, level: .beginner, title: "Circuit découverte 30 min",
                blocks: [b("échauffement", m(6)), b("squats", 40, x: 4, rest: 20), b("pompes sur les genoux", 40, x: 4, rest: 20),
                         b("gainage", 30, x: 4, rest: 30), b("fentes", 40, x: 4, rest: 20), b("pont fessier", 40, x: 4, rest: 20),
                         b("étirements", m(6))]),
        Workout(id: "str-b2", kind: .functionalStrength, level: .beginner, title: "Bas du corps en douceur",
                blocks: [b("échauffement", m(6)), b("fentes", 40, x: 4, rest: 20), b("pont fessier", 40, x: 4, rest: 20),
                         b("chaise contre le mur", 30, x: 4, rest: 30), b("squats", 40, x: 4, rest: 20), b("mollets", 40, x: 4, rest: 20),
                         b("étirements", m(6))]),
        Workout(id: "str-a1", kind: .functionalStrength, level: .amateur, title: "Circuit complet 35 min",
                blocks: [b("échauffement", m(6)), b("fentes", 45, x: 5, rest: 15), b("pompes", 45, x: 5, rest: 15),
                         b("gainage", 45, x: 5, rest: 15), b("squats sautés", 30, x: 5, rest: 30), b("superman", 40, x: 4, rest: 20),
                         b("étirements", m(6))]),
        Workout(id: "str-a2", kind: .functionalStrength, level: .amateur, title: "Haut du corps et gainage",
                blocks: [b("échauffement", m(6)), b("pompes", 40, x: 5, rest: 20), b("dips sur chaise", 40, x: 5, rest: 20),
                         b("gainage latéral", 30, x: 5, rest: 30), b("superman", 40, x: 5, rest: 20), b("rowing élastique", 40, x: 4, rest: 20),
                         b("étirements", m(6))]),
        ...
        Workout(id: "str-c2", kind: .functionalStrength, level: .confirmed, title: "Force et explosivité",
                blocks: [b("échauffement", m(6)), b("squats pistol assistés", 40, x: 5, rest: 20), b("pompes claquées", 30, x: 5, rest: 30),
                         b("montées de genoux", 45, x: 5, rest: 15), b("fentes sautées", 30, x: 5, rest: 30), b("gainage bras tendus", 60, x: 4, rest: 30),
                         b("étirements", m(6))]),
        // HIIT
        Workout(id: "hiit-b1", kind: .hiit, level: .beginner, title: "HIIT doux 30 min",
                blocks: [b("échauffement", m(8)), b("effort", 20, x: 8, rest: 40), b("repos", m(3)), b("effort", 20, x: 8, rest: 40),
                         b("retour au calme", m(6))]),
        Workout(id: "hiit-b2", kind: .hiit, level: .beginner, title: "Intervalles 30/60",
                blocks: [b("échauffement", m(8)), b("effort", 30, x: 10, rest: 60), b("repos", m(2)), b("retour au calme", m(7))]),
        Workout(id: "hiit-a1", kind: .hiit, level: .amateur, title: "Tabata, trois blocs",
                blocks: [b("échauffement", m(8)), b("effort", 20, x: 8, rest: 10), b("repos", m(2)), b("effort", 20, x: 8, rest: 10),
                         b("repos", m(2)), b("effort", 20, x: 8, rest: 10), b("retour au calme", m(7))]),
        Workout(id: "hiit-a2", kind: .hiit, level: .amateur, title: "HIIT 40/20",
                blocks: [b("échauffement", m(8)), b("effort", 40, x: 14, rest: 20), b("repos", m(2)), b("effort", 40, x: 6, rest: 20),
                         b("retour au calme", m(6))]),
        Workout(id: "hiit-c1", kind: .hiit, level: .confirmed, title: "HIIT 30/15, deux blocs",
                blocks: [b("échauffement", m(8)), b("effort", 30, x: 14, rest: 15), b("repos", m(3)), b("effort", 30, x: 14, rest: 15),
                         b("retour au calme", m(6))]),
        Workout(id: "hiit-c2", kind: .hiit, level: .confirmed, title: "Pyramide",
                blocks: [b("échauffement", m(8)), b("effort", 20, x: 2, rest: 20), b("effort", 40, x: 2, rest: 20), b("effort", 60, x: 2, rest: 30),
                         b("effort", 40, x: 2, rest: 20), b("effort", 20, x: 2, rest: 20), b("repos", m(3)),
                         b("effort", 20, x: 2, rest: 20), b("effort", 40, x: 2, rest: 20), b("effort", 60, x: 2, rest: 30),
                         b("effort", 40, x: 2, rest: 20), b("effort", 20, x: 2, rest: 20), b("retour au calme", m(7))]),
        // Autre
